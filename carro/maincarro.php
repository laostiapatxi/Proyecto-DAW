...
<div class="table_carro">
                ...
                foreach($carro as $producto){
                    ...
                    ?><tr>
                        ...
                        <td><form action="maincarro.php" method="post"><input type="submit"  name="restar" value="-"><?php  echo " ".$producto["cantidad"]." ";?>
                            ...
                            <input type="text" name="talla" value="<?php echo $producto["talla"];?>" hidden="hide" >
                ...
                ?>
                    <tr><th colspan="3">Total</th><td class="td-dcha" colspan="2">
            ...
            <form method="post" action="maincarro.php">
                ...
                <?php if(isset($_SESSION['nombre'])){
                  ...
                  <?php
                    ...
                    ?><a  href="#" data-toggle="modal" data-target="#login" class="btn btn-primary cb2 ">Iniciar sesion</a>
                    <?php
                } ?>
...
if(isset($_POST['comprame'])){
	...
	foreach($carro as $producto){
           ...
           $array2=[$cod,$cantidad,$precio,$imagen,$id_pedido,$nombre,$total,$talla,$tipo];
...
<script type="text/javascript">
    ...
    function boton(){
        location.href="../tienda/tienda.php";
    }
